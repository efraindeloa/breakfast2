          ...
          <div className="flex gap-3 w-full">
            ...
            <div className="flex flex-col gap-3 w-1/2">
              ...
              {accountType !== 'restaurant' && (
                ...
                >
                  <div className="flex items-center justify-center size-10 rounded-lg bg-orange-100 dark:bg-orange-900/30 group-hover:bg-orange-600 transition-colors shrink-0 mb-2">
                    <span className="material-symbols-outlined text-orange-600 dark:text-orange-400 group-hover:text-white">calendar_month</span>
                  </div>
                  <div className="flex flex-col gap-1.5 flex-1 min-h-0 min-w-0">
                    <h2 className="text-[#111813] dark:text-white text-base font-bold leading-tight line-clamp-2">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-2">
                      {t('home.makeReservationDescription')}
                    </p>
                  </div>
                </div>
              )}
