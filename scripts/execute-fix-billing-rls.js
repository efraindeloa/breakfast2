...
const sqlFile = join(__dirname, '../supabase/fix-billing-config-rls-simple.sql');
...
async function displaySQLAndInstructions() {
  try {
    ...
    console.log('\n🔧 ========================================');
    console.log('   CORRECCIÓN SIMPLE DE RLS PARA restaurant_billing_config');
    console.log('========================================\n');
    ...
    console.log('   4. Este script crea políticas MUY PERMISIVAS para restaurant_billing_config');
    console.log('      (cualquier usuario autenticado puede leer y modificar)\n');
    console.log('═══════════════════════════════════════════════════════════════════════════════\n');
