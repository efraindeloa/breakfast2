...
const sqlFile = join(__dirname, '../supabase/fix-restaurant-rls-policies.sql');
...
async function displaySQLAndInstructions() {
  try {
    ...
    console.log('\n📋 ========================================');
    console.log('   CORRECCIÓN DE POLÍTICAS RLS');
    console.log('========================================\n');
    ...
    console.log('   4. Esto corregirá las políticas RLS para evitar recursión infinita\n');
    console.log('═══════════════════════════════════════════════════════════════════════════════\n');
