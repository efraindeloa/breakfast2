...
-- Este script crea un restaurante de ejemplo y lo asocia al primer usuario de la tabla users
-- Ejecutar en Supabase SQL Editor

-- 1. Obtener el primer usuario (o cambiar el user_id manualmente)
DO $$
DECLARE
  v_user_id UUID;
...
BEGIN
  ...
  -- 2. Crear o obtener el restaurante
  ...
  -- 3. Asociar el usuario al restaurante como owner
  ...
  -- 4. Crear configuraciones de ejemplo
  ...
  RAISE NOTICE '✅ Restaurante de ejemplo creado!';
